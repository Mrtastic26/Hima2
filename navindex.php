...
<body>
    <div id="navbar1" class="connav">
        <div class="nav">
            ...
            <div class="navtext">
                <a href="index.html"><h2 class="thome">Beranda</h2></a>
                <div class="dropdown">
                    <a href="index.html"><h2 class="ttentang">Tentang </h2></a>
                    
                    
                </div>
                <div class="dropdown">
                    <a href="index.html"><h2 class="tdivisi">Divisi ▼</h2></a>
                ...
                <a href="index.html"><h2 class="tevent">Gallery</h2></a>
                <div class="dropdown">
                    <a href="index.html"><h2 class="tsosmed">Sosmed ▼</h2></a>
                    <div class="dropdown-content">
